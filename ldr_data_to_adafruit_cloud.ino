...
//config file re changes karibaku padiba
// photocell state
int current = 0;
int last = -1;

// set up the 'analog' feed
AdafruitIO_Feed *analog = io.feed("analog");//ae feed ra name ta same heba katha sae feed name sangare jauta aame adafruit dae thiba feed section
